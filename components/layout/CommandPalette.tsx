...
const SHORTCUTS: Shortcut[] = [
  ...
  { label: 'Matching', description: 'VA match suggestions and onboarding flags', href: '/matching', icon: Handshake, adminOnly: true },
  { label: 'Work Logs', description: 'Hours logged against assignments', href: '/work-logs', icon: ListTodo, keywords: 'hours timesheet', adminOnly: true },
